...
//    @objc public var popup = true //네이버페이 등 특정 PG 일 경우 popup을 true로 해야함
    ...
    @objc public var cardEasyOption: BootExtraCardEasyOption?
    @objc public var browserOpenType: [BrowserOpenType]?
    
//    @objc public var BootExtraCardEasyOption cardEasyOption;
//    @objc public List<BrowserOpenType> browserOpenType;
